...
const TEILNEHMERANMELDUNG_FIELDS = [
  ...
  { key: 'teilnehmer_email', label: 'E-Mail', type: 'string/email' },
  { key: 'teilnehmer_telefon', label: 'Telefon', type: 'string/tel' },
