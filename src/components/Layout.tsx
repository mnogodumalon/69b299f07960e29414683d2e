...
const APP_TITLE = 'Yoga Kurs Management';
...
const navigation = [
  ...
  { name: 'Yoga Kurs Management', href: '/yoga-kurs-management', icon: BookOpen },
  { name: 'Kursleiter-Verwaltung', href: '/kursleiter-verwaltung', icon: BookOpen },
];

const externalNavigation = [
  { name: 'Teilnehmer-Anmeldung', href: '/gateway/apps/69b299d6613496ad24b9483a?template=list_page', icon: Users },
  { name: 'Kurs-Verwaltung', href: '/gateway/apps/69b299d62510305efd4cefc5?template=list_page', icon: BookOpen },
  { name: 'Yoga Kurs Management', href: '/gateway/apps/69b299f02fe7e06a23a283f9?template=list_page', icon: BookOpen },
  { name: 'Kursleiter-Verwaltung', href: '/gateway/apps/69b299d1b93ba834c1f3484d?template=list_page', icon: BookOpen },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69b299d6613496ad24b9483a?template=list_page"
